import {
  ...
  registerButton,
  utils_exports
} from "./chunk-B4LAJVN5.js";

// node_modules/@photo-sphere-viewer/markers-plugin/index.module.js
...
var _MarkerVisibilityEvent = class _MarkerVisibilityEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(marker, visible) {
    super(_MarkerVisibilityEvent2.type);
    this.marker = marker;
...
var _GotoMarkerDoneEvent = class _GotoMarkerDoneEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(marker) {
    super(_GotoMarkerDoneEvent2.type);
    this.marker = marker;
  }
};
_GotoMarkerDoneEvent.type = "goto-marker-done";
var GotoMarkerDoneEvent = _GotoMarkerDoneEvent;
var _LeaveMarkerEvent = class _LeaveMarkerEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(marker) {
    super(_LeaveMarkerEvent2.type);
    this.marker = marker;
  }
};
_LeaveMarkerEvent.type = "leave-marker";
var LeaveMarkerEvent = _LeaveMarkerEvent;
var _EnterMarkerEvent = class _EnterMarkerEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(marker) {
    super(_EnterMarkerEvent2.type);
    this.marker = marker;
  }
};
_EnterMarkerEvent.type = "enter-marker";
var EnterMarkerEvent = _EnterMarkerEvent;
var _SelectMarkerEvent = class _SelectMarkerEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(marker, doubleClick, rightClick) {
    super(_SelectMarkerEvent2.type);
    this.marker = marker;
...
var _SelectMarkerListEvent = class _SelectMarkerListEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(marker) {
    super(_SelectMarkerListEvent2.type);
    this.marker = marker;
  }
};
_SelectMarkerListEvent.type = "select-marker-list";
var SelectMarkerListEvent = _SelectMarkerListEvent;
var _UnselectMarkerEvent = class _UnselectMarkerEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(marker) {
    super(_UnselectMarkerEvent2.type);
    this.marker = marker;
  }
};
_UnselectMarkerEvent.type = "unselect-marker";
var UnselectMarkerEvent = _UnselectMarkerEvent;
var _HideMarkersEvent = class _HideMarkersEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor() {
    super(_HideMarkersEvent2.type);
  }
};
_HideMarkersEvent.type = "hide-markers";
var HideMarkersEvent = _HideMarkersEvent;
var _SetMarkersEvent = class _SetMarkersEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(markers) {
    super(_SetMarkersEvent2.type);
    this.markers = markers;
  }
};
_SetMarkersEvent.type = "set-markers";
var SetMarkersEvent = _SetMarkersEvent;
var _ShowMarkersEvent = class _ShowMarkersEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor() {
    super(_ShowMarkersEvent2.type);
  }
};
_ShowMarkersEvent.type = "show-markers";
var ShowMarkersEvent = _ShowMarkersEvent;
var _RenderMarkersListEvent = class _RenderMarkersListEvent2 extends MarkersPluginEvent {
  /** @internal */
  constructor(markers) {
    super(_RenderMarkersListEvent2.type);
    this.markers = markers;
  }
};
...
var MARKER_DATA_KEY = utils_exports.dasherize(MARKER_DATA);
...
`;
var MarkersListButton = class extends AbstractButton {
  constructor(navbar) {
    super(navbar, {
    ...
    this.plugin = this.viewer.getPlugin("markers");
    if (this.plugin) {
      this.viewer.addEventListener(events_exports.ShowPanelEvent.type, this);
      this.viewer.addEventListener(events_exports.HidePanelEvent.type, this);
    }
  }
  destroy() {
    this.viewer.removeEventListener(events_exports.ShowPanelEvent.type, this);
    this.viewer.removeEventListener(events_exports.HidePanelEvent.type, this);
    super.destroy();
  }
  isSupported() {
    return !!this.plugin;
  ...
  handleEvent(e) {
    if (e instanceof events_exports.ShowPanelEvent) {
      this.toggleActive(e.panelId === ID_PANEL_MARKERS_LIST);
    } else if (e instanceof events_exports.HidePanelEvent) {
      this.toggleActive(false);
    }
  }
  onClick() {
...
var CSS3DContainer = class {
  constructor(viewer) {
    ...
    viewer.addEventListener(events_exports.ReadyEvent.type, this, { once: true });
    viewer.addEventListener(events_exports.SizeUpdatedEvent.type, this);
    viewer.addEventListener(events_exports.RenderEvent.type, this);
  }
  handleEvent(e) {
    switch (e.type) {
      case events_exports.ReadyEvent.type:
      case events_exports.SizeUpdatedEvent.type:
        this.updateSize();
        break;
      case events_exports.RenderEvent.type:
        this.render();
        break;
    }
  }
  destroy() {
    this.viewer.removeEventListener(events_exports.ReadyEvent.type, this);
    this.viewer.removeEventListener(events_exports.SizeUpdatedEvent.type, this);
    this.viewer.removeEventListener(events_exports.RenderEvent.type, this);
...
var Marker = class {
  ...
  update(config) {
    ...
    this.config = utils_exports.deepmerge(this.config, config);
    ...
    if (utils_exports.isNil(this.config.visible)) {
      this.config.visible = true;
    }
    if (utils_exports.isNil(this.config.zIndex)) {
      this.config.zIndex = 1;
    }
    if (utils_exports.isNil(this.config.opacity)) {
    ...
    if (this.config.rotation) {
      ...
      if (typeof rot === "object") {
        this.config.rotation = {
          yaw: rot.yaw ? utils_exports.parseAngle(rot.yaw, true, false) : 0,
          pitch: rot.pitch ? utils_exports.parseAngle(rot.pitch, true, false) : 0,
          roll: rot.roll ? utils_exports.parseAngle(rot.roll, true, false) : 0
        };
      } else {
        this.config.rotation = {
          yaw: 0,
          pitch: 0,
          roll: utils_exports.parseAngle(rot, true, false)
        };
      }
    } else {
      this.config.rotation = { yaw: 0, pitch: 0, roll: 0 };
    }
    this.state.anchor = utils_exports.parsePoint(this.config.anchor);
  }
  /**
  ...
  getListContent() {
    ...
    } else if ((_a = this.config.tooltip) == null ? void 0 : _a.content) {
  ...
  showTooltip(clientX, clientY, forceUpdate = false) {
    var _a;
    if (this.state.visible && ((_a = this.config.tooltip) == null ? void 0 : _a.content) && this.state.position2D) {
      const config = {
        ...this.config.tooltip,
        style: {
      ...
      if (this.isPoly() || this.is3d() || this.isCss3d()) {
        if (clientX || clientY) {
          const viewerPos = utils_exports.getPosition(this.viewer.container);
...
var AbstractDomMarker = class extends Marker {
  ...
  update(config) {
    ...
    if (this.config.className) {
      utils_exports.addClasses(element, this.config.className);
    }
...
var AbstractStandardMarker = class extends AbstractDomMarker {
  ...
  update(config) {
    super.update(config);
    if (!utils_exports.isExtendedPosition(this.config.position)) {
  ...
  applyScale({
    ...
    if (typeof this.config.scale === "function") {
      ...
      if (Array.isArray(this.config.scale.zoom)) {
        ...
        scale *= min + (max - min) * constants_exports.EASINGS.inQuad(zoomLevel / 100);
      }
      if (Array.isArray(this.config.scale.yaw)) {
        ...
        const arc = Math.abs(utils_exports.getShortestArc(this.state.position.yaw, viewerPosition.yaw));
        scale *= max + (min - max) * constants_exports.EASINGS.outQuad(Math.max(0, (halfFov - arc) / halfFov));
      }
    }
...
var ChromaKeyMaterial = class extends ShaderMaterial {
  ...
  set chromaKey(chromaKey) {
    this.uniforms.keying.value = (chromaKey == null ? void 0 : chromaKey.enabled) === true;
    if (chromaKey == null ? void 0 : chromaKey.enabled) {
  ...
  constructor(params) {
    super({
      ...
      depthWrite: false,
      uniforms: {
        map: { value: params == null ? void 0 : params.map },
        repeat: { value: new Vector2(1, 1) },
        offset: { value: new Vector2(0, 0) },
        alpha: { value: (params == null ? void 0 : params.alpha) ?? 1 },
        keying: { value: false },
    ...
    this.chromaKey = params == null ? void 0 : params.chromaKey;
  }
};
...
function greatArcIntermediaryPoint(p1, p2, f) {
  const [λ1, φ1] = p1;
  const [λ2, φ2] = p2;
  const r = utils_exports.greatArcDistance(p1, p2);
...
function getPolylineCenter(polyline) {
  ...
  for (let i = 0; i < points.length - 1; i++) {
    const l = utils_exports.greatArcDistance(points[i], points[i + 1]) * constants_exports.SPHERE_RADIUS;
    lengths.push(l);
    length += l;
  }
  let consumed = 0;
...
function getGreatCircleIntersection(P1, P2, direction) {
  ...
  A.crossVectors(H, C);
  return H.applyAxisAngle(A, 0.01).multiplyScalar(constants_exports.SPHERE_RADIUS);
}
var Marker3D = class extends Marker {
  ...
  update(config) {
    ...
    if (utils_exports.isExtendedPosition(this.config.position)) {
      ...
      if (((_a = this.config.position) == null ? void 0 : _a.length) !== 4) {
        throw new PSVError(`missing marker ${this.id} position`);
      }
      let positions;
      try {
    ...
    switch (this.type) {
      case "videoLayer":
        if (this.definition !== this.config.videoLayer) {
          (_b = material.map) == null ? void 0 : _b.dispose();
      ...
      case "imageLayer":
        if (this.definition !== this.config.imageLayer) {
          (_c = material.map) == null ? void 0 : _c.dispose();
  ...
  __setTextureWrap(material) {
    ...
    const w1 = utils_exports.greatArcDistance(
      [positions[0].yaw, positions[0].pitch],
      [positions[1].yaw, positions[1].pitch]
    );
    const w2 = utils_exports.greatArcDistance(
      [positions[3].yaw, positions[3].pitch],
      [positions[2].yaw, positions[2].pitch]
    );
    const h1 = utils_exports.greatArcDistance(
      [positions[1].yaw, positions[1].pitch],
      [positions[2].yaw, positions[2].pitch]
    );
    const h2 = utils_exports.greatArcDistance(
      [positions[0].yaw, positions[0].pitch],
      [positions[3].yaw, positions[3].pitch]
    );
...
var MarkerCSS3D = class extends AbstractDomMarker {
  ...
  render({
    ...
    if (isVisible) {
      ...
      (_b = (_a = this.config.elementLayer).updateMarker) == null ? void 0 : _b.call(_a, {
        marker: this,
        position,
        viewerPosition,
        zoomLevel,
...
var MarkerNormal = class extends AbstractStandardMarker {
  ...
  render(params) {
    ...
    if (position && this.type === "element") {
      (_b = (_a = this.config.element).updateMarker) == null ? void 0 : _b.call(_a, {
        marker: this,
        position,
...
var MarkerPolygon = class extends AbstractDomMarker {
   ...
   */
  get isPixels() {
    return this.type === "polygonPixels" || this.type === "polylinePixels";
  }
  /**
   * Checks if it is a polygon marker
   */
  get isPolygon() {
    return this.type === "polygon" || this.type === "polygonPixels";
  }
  /**
   * Checks if it is a polyline marker
   */
  get isPolyline() {
    return this.type === "polyline" || this.type === "polylinePixels";
  }
  get coords() {
  ...
  update(config) {
    ...
    if (this.config.svgStyle) {
      Object.entries(this.config.svgStyle).forEach(([prop, value]) => {
        element.setAttributeNS(null, utils_exports.dasherize(prop), value);
      });
      ...
      if (this.isPixels) {
        this.definition = actualPoly.map((coords) => {
          return coords.map((coord) => {
            let sphericalCoord;
            if (utils_exports.isExtendedPosition(coord)) {
...
var MarkerSvg = class extends AbstractStandardMarker {
  ...
  update(config) {
    ...
    if (this.config.svgStyle) {
      Object.entries(this.config.svgStyle).forEach(([prop, value]) => {
        svgElement.setAttributeNS(null, utils_exports.dasherize(prop), value);
      });
    } else {
...
var getConfig = utils_exports.getConfigParser(
  {
...
var _MarkersPlugin = class _MarkersPlugin2 extends AbstractConfigurablePlugin {
  ...
  init() {
    super.init();
    utils_exports.checkStylesheet(this.viewer.container, "markers-plugin");
    this.viewer.addEventListener(events_exports.ClickEvent.type, this);
    this.viewer.addEventListener(events_exports.DoubleClickEvent.type, this);
    this.viewer.addEventListener(events_exports.RenderEvent.type, this);
    this.viewer.addEventListener(events_exports.ConfigChangedEvent.type, this);
    this.viewer.addEventListener(events_exports.ObjectEnterEvent.type, this);
    this.viewer.addEventListener(events_exports.ObjectHoverEvent.type, this);
    this.viewer.addEventListener(events_exports.ObjectLeaveEvent.type, this);
    this.viewer.addEventListener(events_exports.ReadyEvent.type, this, { once: true });
  }
  /**
   * @internal
   */
  destroy() {
    ...
    this.viewer.removeEventListener(events_exports.ClickEvent.type, this);
    this.viewer.removeEventListener(events_exports.DoubleClickEvent.type, this);
    this.viewer.removeEventListener(events_exports.RenderEvent.type, this);
    this.viewer.removeEventListener(events_exports.ObjectEnterEvent.type, this);
    this.viewer.removeEventListener(events_exports.ObjectHoverEvent.type, this);
    this.viewer.removeEventListener(events_exports.ObjectLeaveEvent.type, this);
    this.viewer.removeEventListener(events_exports.ReadyEvent.type, this);
  ...
  handleEvent(e) {
    ...
    switch (e.type) {
      ...
      case events_exports.RenderEvent.type:
        this.renderMarkers();
        break;
      case events_exports.ClickEvent.type:
        this.__onClick(e, false);
        break;
      case events_exports.DoubleClickEvent.type:
        this.__onClick(e, true);
        break;
      case events_exports.ObjectEnterEvent.type:
      case events_exports.ObjectLeaveEvent.type:
      case events_exports.ObjectHoverEvent.type:
        if (e.userDataKey === MARKER_DATA) {
          const event = e.originalEvent;
          const marker = e.object.userData[MARKER_DATA];
          switch (e.type) {
            case events_exports.ObjectEnterEvent.type:
              if ((_a = marker.config.style) == null ? void 0 : _a.cursor) {
        ...
        break;
      case "mouseenter": {
        const marker = this.__getTargetMarker(utils_exports.getEventTarget(e));
      ...
      case "mousemove": {
        const marker = this.__getTargetMarker(utils_exports.getEventTarget(e), true);
  ...
  updateMarker(config, render = true) {
    ...
    if (render) {
      this.__afterChangeMarkers();
      if (marker === this.state.hoveringMarker && ((_a = marker.config.tooltip) == null ? void 0 : _a.trigger) === "hover" || marker.state.staticTooltip) {
  ...
  setMarkers(markers, render = true) {
    this.clearMarkers(false);
    markers == null ? void 0 : markers.forEach((marker) => {
  ...
  gotoMarker(markerId, speed = this.config.gotoMarkerSpeed) {
    ...
    if (!speed) {
      ...
      if (!utils_exports.isNil(marker.config.zoomLvl)) {
  ...
  toggleMarker(markerId, visible) {
    const marker = this.getMarker(markerId);
    marker.config.visible = utils_exports.isNil(visible) ? !marker.config.visible : visible;
    this.renderMarkers();
  }
  /**
  ...
  showMarkersList() {
    ...
    this.viewer.panel.show({
      ...
      noMargin: true,
      clickHandler: (target) => {
        const li = utils_exports.getClosest(target, ".psv-panel-menu-item");
  ...
  renderMarkers() {
    ...
    Object.values(this.markers).forEach((marker) => {
      ...
      if (marker.domElement) {
        utils_exports.toggleClass(marker.domElement, "psv-marker--visible", isVisible);
      }
      if (!isVisible) {
        marker.hideTooltip();
  ...
  __getTargetMarker(target, closest = false) {
    if (target instanceof Node) {
      const target2 = closest ? utils_exports.getClosest(target, ".psv-marker") : target;
  ...
  __onEnterMarker(e, marker) {
    ...
    if (marker) {
      ...
      if (!marker.state.staticTooltip && ((_a = marker.config.tooltip) == null ? void 0 : _a.trigger) === "hover") {
  ...
  __onHoverMarker(e, marker) {
    ...
    if (marker) {
      ...
      if (marker.isPoly() || marker.is3d() || marker.isCss3d()) {
        if (((_a = marker.config.tooltip) == null ? void 0 : _a.trigger) === "hover") {
          marker.showTooltip(e.clientX, e.clientY);
        }
      }
    }
  ...
  __onClick(e, dblclick) {
    ...
    if (this.state.currentMarker && this.state.currentMarker !== marker) {
      ...
      this.viewer.panel.hide(ID_PANEL_MARKER);
      if (!this.state.showAllTooltips && ((_a = this.state.currentMarker.config.tooltip) == null ? void 0 : _a.trigger) === "click") {
    ...
    if (marker) {
      ...
      if (this.markers[marker.id] && !e.data.rightclick) {
        if (((_b = marker.config.tooltip) == null ? void 0 : _b.trigger) === "click") {
          if (marker.tooltip) {
  ...
  __refreshUi() {
    ...
    (_a = this.viewer.navbar.getButton(MarkersButton.id, false)) == null ? void 0 : _a.toggle(nbMarkers > 0);
    (_b = this.viewer.navbar.getButton(MarkersListButton.id, false)) == null ? void 0 : _b.toggle(nbMarkers > 0);
  }
  /**
...
@photo-sphere-viewer/markers-plugin/index.module.js:
   ...
   *)
*/
//# sourceMappingURL=@photo-sphere-viewer_markers-plugin.js.map
